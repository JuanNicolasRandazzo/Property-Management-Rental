...
namespace ASPN.Property_Rental_Management_Final_Project.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MessageID,SenderID,ReceiverID,MessageText,DateAndTime")] Message message)
        {
            ...
            var propertyManagers = db.Users.Where(u => u.Role == "PropertyManager").ToList();

            
            var propertyManagerList = propertyManagers.Select(pm => new SelectListItem
            {
            ...
            propertyManagerList.Insert(0, new SelectListItem { Value = "", Text = "Select Property Manager" });


            ViewBag.ReceiverID = new SelectList(propertyManagerList, "Value", "Text", message.ReceiverID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MessageID,SenderID,ReceiverID,MessageText,DateAndTime")] Message message)
        {
            if (ModelState.IsValid)
            {
