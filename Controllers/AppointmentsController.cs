...
namespace ASPN.Property_Rental_Management_Final_Project.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AppointmentID,TenantID,EmployeeID,DateAndTime")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AppointmentID,TenantID,EmployeeID,DateAndTime")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
